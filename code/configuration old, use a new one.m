...
CONFIG.to_sink_data_rate = 1*1024^2; % [kbps] 1Gbps ethernet
...
elseif strcmp(ANTENNAS.technology{1}.name,'wimax')
  ANTENNAS.technology{1}.frequency = 3.5e3; % [MHz] 3.5 preffered (Bruno Lyra) 2.5e3 or 3.5e3 according to wiki page List_of_WiMAX_networks
...
ANTENNAS.technology{2}.frequency = 3.5e3; % [MHz]
...
ANTENNAS.technology{2}.bandwidth = 20e6; % [Hz] %bandwidth - what the whole equipment (including radio and antenna supports
  ...
  ANTENNAS.technology{1}.frequency = 2.5e3; % 5.4 or 5.8   % [MHz] -> 2.4e3 = 2.4GHz
